  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40px] leading-[36px] text-white">Yumustyung</h4>
          <p className="mt-[8px] font-normal sm:text-[18px] text-[12pxx] sm:leading-[22px] leading-[16px] text-white">Founder | Multiversus</p>
        </div>
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18pxx] sm:leading-[45px] leading-[39px] text-white"> 
